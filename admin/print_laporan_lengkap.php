...
if (isset($_POST['submit'])) {
 ...
 <?php
   include '../config/koneksi.php';
 			...
 			if (!isset($_POST['cari']) && empty($_POST['pencarian'])) {
 	 			$sql=mysql_query("SELECT * FROM tb_rekam_medis ORDER BY id desc ");
 ...
 include '../config/koneksi.php';
     $no=0;
       $sql=mysql_query("SELECT * FROM tb_pendaftaran WHERE stts ='2' ORDER BY no_pendaftaran desc ");
       while($bc=mysql_fetch_array($sql)){
...
<?php
 include '../config/koneksi.php';
     $no=0;
       $sql=mysql_query("SELECT * FROM tb_pasien WHERE stts='1'  ORDER BY id_pasien desc ");
       while($bc=mysql_fetch_array($sql)){
  $no++;
 ?>
 <tbody>
...
include '../config/koneksi.php';
    $no=0;
      $sql=mysql_query("SELECT * FROM tb_dokter WHERE stts='1'  ORDER BY id_dokter desc ");
      while($bc=mysql_fetch_array($sql)){
        $sql2 = mysql_query("SELECT * FROM tb_user WHERE id_dokter='$bc[id_dokter]'");
        $bc2  = mysql_fetch_array($sql2);
 $no++;
?>
<tbody>
