...
<body>
	<table>
		<tr>
			<td widht="60%"><h1>Data Pendaftaran Antrian Periksa</h1></td>
			<td width="60%" align="right" valign="bottom"><a href="?menu=inputPendaftaran"><h4>Tambah Pendaftaran</h4></a></td>
		</tr>
	</table>
...
<?php
  include '../config/koneksi.php';
	 		$no=0;
	 			$sql=mysql_query("SELECT * FROM tb_pendaftaran WHERE stts ='1' ORDER BY no_pendaftaran desc ");
  ...
  <tr>
    		...
    		<td><?php
				if ($bc['stts']=='1') {
				 ...
				 echo @$status; ?></td>
    <td>
			<!--<a href="?menu=editPasien&id=<?php echo"$bc[no_pendaftaran]"; ?>">
