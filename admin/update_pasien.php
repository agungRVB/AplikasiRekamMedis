<?php
 include '../config/koneksi.php';
  $sql1 = mysql_query("SELECT * FROM tb_pasien WHERE id_pasien='$_GET[id]'");
...
include '../config/koneksi.php';
 ...
 if(isset($_POST['kirim'])){
	...
	$sql1 = "UPDATE tb_pasien SET nik_pasien='$nik_pasien', nama_pasien='$nama_pasien', umur='$umur',  jk='$jk', tgl_lahir='$tgl_lahir', alamat_pasien='$alamat_pasien' WHERE id_pasien='$_GET[id]'";
	mysql_query($sql1);
