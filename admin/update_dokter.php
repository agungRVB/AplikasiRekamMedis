<?php
    ...
    $sql4 = mysql_query("SELECT * FROM tb_dokter WHERE id_dokter='$_GET[id]'");
    $bc4  = mysql_fetch_array($sql4);

    $sql5 = mysql_query("SELECT * FROM tb_user WHERE id_dokter='$_GET[id]'");
...
if(isset($_POST['kirim'])){
      ...
      $sql1 = "UPDATE tb_dokter SET nama_dokter='$nama_dokter', jk_dokter='$jk_dokter',
               alamat_dokter='$alamat_dokter', umur='$umur' WHERE id_dokter='$_GET[id]'";
      mysql_query($sql1);

                $sql2 = "UPDATE tb_user SET pengguna='$pengguna',  sandi='$sandi' WHERE id_dokter='$_GET[id]'";
                mysql_query($sql2);
