...
<?php
  include '../config/koneksi.php';
	@session_start();
	$sqllogin = mysql_query("SELECT * FROM tb_user WHERE pengguna='$_SESSION[user]' AND sandi='$_SESSION[pass]'");
	$cek_log	=	mysql_fetch_array($sqllogin);
	 		$no=0;
	 			$sql=mysql_query("SELECT * FROM tb_pendaftaran WHERE stts='1' AND id_dokter='$cek_log[id_dokter]'");
