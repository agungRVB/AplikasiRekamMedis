<?php
    ...
    $sql5 = mysql_query("SELECT * FROM tb_rekam_medis WHERE id='$_GET[id]'");
...
<div class="col-lg-6">
             ...
             <div class="form-group">
                      ...
                      <?php
                              include '../config/koneksi.php';
                              $sql1 = mysql_query("SELECT * FROM tb_pasien WHERE id_pasien='$bc5[id_pasien]'");
              ...
              <div class="form-group">
                       ...
                       <?php
                               include '../config/koneksi.php';
                               $sql2 = mysql_query("SELECT * FROM tb_dokter WHERE id_dokter='$bc5[id_dokter]'");
...
if(isset($_POST['kirim'])){
      ...
      $sql6 = "UPDATE tb_rekam_medis SET umur='$umur', terapi='$terapi', diagnosa='$diagnosa' WHERE id='$_GET[id]'";
      mysql_query($sql6);
